...
train_dir = '/home/liuk/dl/pytorch/data/newdata/train'
train_datasets = datasets.ImageFolder(train_dir, transform=train_transforms)
train_dataloader = torch.utils.data.DataLoader(train_datasets, batch_size=batch_size, shuffle=True)

val_dir = '/home/liuk/dl/pytorch/data/newdata/val'
    ...
    for phase in ['train', 'val']:
        ...
        for batch_x, batch_y in train_dataloader:
            ...
            with torch.set_grad_enabled(phase == 'train'):
                ...
                if phase == 'train':
                    out,aux = model(batch_x)
                    loss1 = loss_func(out, batch_y)
                    loss2=loss_func(aux, batch_y)
            ...
            train_correct = (preds == batch_y).sum()
...
plt.subplot(2, 1, 2)
plt.plot(x2, y2, '.-')
plt.xlabel('Validation Loss vs. Number of Training Epochs')
plt.ylabel('Validation loss')
plt.show()
plt.savefig("results/accuracy_loss.jpg")
